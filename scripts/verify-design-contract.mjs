...
const requiredSlots=["home_banner_desktop","home_banner_mobile","home_side_desktop","guide_native_mid"];
...
for(const slot of design.adInventory){
  if(slot.slotName==="social_global"||slot.format==="social_bar")fail("SocialBar is prohibited");
